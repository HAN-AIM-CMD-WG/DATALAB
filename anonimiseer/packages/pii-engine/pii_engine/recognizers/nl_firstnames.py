...
__all__ = ["FIRST_NAMES", "NlFirstNameRecognizer"]
...
# bij de apostrof).
_WORD_PATTERN = re.compile(r"(?<![A-Za-zÀ-ÿ])(?P<w>[A-ZÀ-Þ][a-zà-ÿ]{2,})(?![A-Za-zÀ-ÿ])")
...
_SURNAME_CAP_TOKEN = re.compile(rf"\s+(?P<w>{_SURNAME_TOKEN})(?!\d)")
